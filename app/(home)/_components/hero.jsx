    ...
    return (
        <div className="h-full flex-center">
            ...
            <div className="mx-auto max-w-screen-xl flex flex-col justify-center items-center hero-heading">
                <h2 className="text-color-violet text-center text-xl font-medium">Track Your Academic Performance</h2>
                ...
                <h3 className="text-color-gray text-center font-normal">Elevate Your Grades - Elevate Your Future!</h3>
            </div>
        </div>
    )
}
